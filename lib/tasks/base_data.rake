...
task load_base_data: :environment do
  ...
  categories.each do |category|
    items << category.items.create(store: store_1, description: Faker::Hipster.sentence, price: randomizer.rand(2.00..100.00).round(2), title: Faker::SiliconValley.unique.invention)
    items << category.items.create(store: store_2, description: Faker::Hipster.sentence, price: randomizer.rand(2.00..100.00).round(2), title: Faker::Pokemon.unique.move)
    items << category.items.create(store: store_3, description: Faker::Hipster.sentence, price: randomizer.rand(2.00..100.00).round(2), title: Faker::Beer.unique.name)
    items << category.items.create(store: store_4, description: Faker::Hipster.sentence, price: randomizer.rand(2.00..100.00).round(2), title: Faker::Superhero.unique.power)
    items << category.items.create(store: store_5, description: Faker::Hipster.sentence, price: randomizer.rand(2.00..100.00).round(2), title: Faker::Music.unique.instrument)
  end
